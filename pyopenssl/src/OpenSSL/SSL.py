...
class Context(object):
    ...
    def set_grease_enabled(self, if_true):
        """
        set if use grease

        :param bool if_true: true or false
        :return: None
        """
        _lib.SSL_CTX_set_grease_enabled(self._context, if_true)

    def enable_signed_cert_timestamps(self):
        """
        set signed_cert_timestamps

        :return: None
        """
        _lib.SSL_CTX_enable_signed_cert_timestamps(self._context)

    def enable_ocsp_stapling(self):
        """
        set signed_cert_timestamps

        :return: None
        """
        _lib.SSL_CTX_enable_ocsp_stapling(self._context)
