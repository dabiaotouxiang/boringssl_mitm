...
size_t BN_bn2bin(const BIGNUM *, unsigned char *);
BIGNUM *BN_bin2bn(const unsigned char *, size_t, BIGNUM *);

unsigned BN_num_bits(const BIGNUM *);
...
unsigned BN_num_bytes(const BIGNUM *);
