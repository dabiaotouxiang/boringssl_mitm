...
int EVP_CIPHER_CTX_set_key_length(EVP_CIPHER_CTX *, unsigned);
...
int PKCS5_PBKDF2_HMAC(const char *, size_t, const unsigned char *, size_t, unsigned,
                      const EVP_MD *, size_t, unsigned char *);
