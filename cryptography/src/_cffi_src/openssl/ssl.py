...
uint32_t SSL_CTX_set_timeout(SSL_CTX *, uint32_t);
...
int SSL_CTX_set_read_ahead(SSL_CTX *, int);
...
int SSL_get_ex_new_index(long, void *, CRYPTO_EX_unused *, CRYPTO_EX_dup *,
                         CRYPTO_EX_free *);
int SSL_set_ex_data(SSL *, int, void *);
int SSL_CTX_get_ex_new_index(long, void *, CRYPTO_EX_unused *, CRYPTO_EX_dup *,
                             CRYPTO_EX_free *);
...
uint64_t SSL_SESSION_get_time(const SSL_SESSION *);
uint32_t SSL_SESSION_get_timeout(const SSL_SESSION *);
int SSL_SESSION_has_ticket(const SSL_SESSION *);
long SSL_SESSION_get_ticket_lifetime_hint(const SSL_SESSION *);

unsigned long SSL_set_mode(SSL *, uint32_t);
unsigned long SSL_clear_mode(SSL *, uint32_t);
unsigned long SSL_get_mode(SSL *);

unsigned long SSL_set_options(SSL *, uint32_t);
...
int SSL_CTX_set_min_proto_version(SSL_CTX *, uint16_t);
int SSL_CTX_set_max_proto_version(SSL_CTX *, uint16_t);
long SSL_set_min_proto_version(SSL *, uint16_t);
long SSL_set_max_proto_version(SSL *, uint16_t);
...
uint32_t SSL_CTX_set_options(SSL_CTX *, uint32_t);
unsigned long SSL_CTX_clear_options(SSL_CTX *, uint32_t);
unsigned long SSL_CTX_get_options(SSL_CTX *);
uint32_t SSL_CTX_set_mode(SSL_CTX *, uint32_t);
unsigned long SSL_CTX_clear_mode(SSL_CTX *, uint32_t);
unsigned long SSL_CTX_get_mode(SSL_CTX *);
int SSL_CTX_set_session_cache_mode(SSL_CTX *, int);
int SSL_CTX_get_session_cache_mode(const SSL_CTX *);
int SSL_CTX_set_tmp_dh(SSL_CTX *, const DH *);
int SSL_CTX_set_tmp_ecdh(SSL_CTX *, const EC_KEY *);
...
long SSL_set_tlsext_status_ocsp_resp(SSL *, unsigned char *, size_t);
size_t SSL_get_tlsext_status_ocsp_resp(SSL *, const unsigned char **);
int SSL_set_tlsext_status_type(SSL *, int);
...
const SRTP_PROTECTION_PROFILE *SSL_get_selected_srtp_profile(SSL *);
...
size_t sk_SSL_CIPHER_num(Cryptography_STACK_OF_SSL_CIPHER *);
const SSL_CIPHER *sk_SSL_CIPHER_value(Cryptography_STACK_OF_SSL_CIPHER *, size_t);
...
int (*SSL_CTX_set_cipher_list)(SSL_CTX *, const char *) = NULL;
