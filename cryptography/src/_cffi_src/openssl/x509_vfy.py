...
int X509_STORE_CTX_get_ex_new_index(long, void *, CRYPTO_EX_unused *,
...
size_t sk_X509_OBJECT_num(Cryptography_STACK_OF_X509_OBJECT *);
X509_OBJECT *sk_X509_OBJECT_value(Cryptography_STACK_OF_X509_OBJECT *, size_t);
